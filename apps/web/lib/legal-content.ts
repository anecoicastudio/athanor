    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Resend recapita le email di accesso che Supabase prepara, come quella per reimpostare la password: riceve il tuo indirizzo e il testo del messaggio.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Resend delivers the sign-in emails Supabase composes, such as the one to reset your password: it receives your address and the text of the message.',
