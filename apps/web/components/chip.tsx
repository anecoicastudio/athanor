 ...
 * selected = foreground/background (DESIGN.md §8 toggle); idle = hairline-bordered.
 */
  ...
  return (
    <button
      ...
      className={cn(
        ...
        selected ? 'bg-foreground text-background' : 'border border-border bg-card text-foreground',
        className,
      )}
      {...props}
    />
