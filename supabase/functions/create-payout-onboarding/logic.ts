...
export type PayoutOnboardingCtx = {
   ...
   * capability flags are written elsewhere (one function, `_shared/payout-account-cache.ts`; two callers, W13 and reconcile-payout-accounts — #707); this function only ever writes the pointer row.
   */
 ...
 * `_shared/payout-account-cache.ts` — the W13 arm and the #707 reconcile — never here (rule #6 — account state is a cache of
