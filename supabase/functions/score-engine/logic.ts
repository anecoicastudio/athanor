...
// boot a 503 BOOT_ERROR on the hosted project (the «Deploy-asset pins» comment in index.ts;
// _shared/deploy-graph.test.ts asserts the property transitively, for this graph and every other
// deployed entrypoint).
