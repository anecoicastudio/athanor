...
// type-level `npm:stripe`: the Stripe capabilities arrive injected. #541 made that module
// lazy, so the import would no longer demand STRIPE_SECRET_KEY in a test env; the boundary
// stays because DI is the point.
...
/**
 * Stripe's standard EEA card rate: 1,5% + €0,25. Named constants, one place.
 *
