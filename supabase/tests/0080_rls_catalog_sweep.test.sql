...
-- PRD.md:417 tripwire. 51 tables are created across supabase/migrations/ and each one has a
...
select is(
  ...
  51,
  'PRD.md:417 tripwire: 51 tables, each with its own pgTAP file (bump only WITH a new test)'
);
