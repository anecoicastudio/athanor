 ...
 *
 * `legal-content.ts` IS the translation source for the site's four legal documents (the privacy
 * policy, which covers the app too, the terms, the account-deletion page and the child safety
 * standards):
